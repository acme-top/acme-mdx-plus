(function () {
	...
	if(script.hasAttribute('data-autoloader-path')) {
		...
		languages_path = Prism.plugins.autoloader.languages_path;
	}
	...
	var getLanguagePath = function (lang) {
		...
		var languages_path = config.languages_path;
		
		if(typeof getPrismAutoloaderLanguagesPath == 'function'){
			languages_path = getPrismAutoloaderLanguagesPath();
		}

		return languages_path + 'prism-' + lang + (config.use_minified ? '.min' : '') + '.js'
	};
